...
const SOURCE_FILE = path.join(ROOT_DIR, 'PRIVACY_POLICY.md');
const OUTPUT_FILE = path.join(ROOT_DIR, 'constants', 'privacyPolicy.ts');

try {
  // PRIVACY_POLICY.md 읽기
...
// PRIVACY_POLICY.md를 수정하면 자동으로 업데이트됩니다.

export const PRIVACY_POLICY_TEXT = \`${markdownContent}\`
`;
